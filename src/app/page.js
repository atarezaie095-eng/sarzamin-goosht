        ...
        <div data-reveal className="grid overflow-hidden rounded-[2rem] bg-[#191512] text-white lg:grid-cols-[.9fr_1.1fr]">
          <div className="p-7 sm:p-10 lg:p-12">
            ...
            <address className="mt-8 space-y-5 not-italic">
              <ContactRow icon="phone" label="شماره تماس" value={site.phoneDisplay} href={contactLinks.phone} />
              <ContactRow icon="pin" label="آدرس فروشگاه" value={site.address} />
              <ContactRow icon="truck" label="محدوده ارسال" value="ارسال سریع در سراسر فاز ۳ اندیشه" />
            </address>
          ...
          <div className="m-3 flex min-h-[390px] flex-col gap-3 rounded-[1.5rem] bg-[#eee9e2] p-3 text-[#181512] lg:min-h-full">
            <iframe
              ...
              src="https://www.google.com/maps?q=%D8%B3%D8%B1%D8%B2%D9%85%DB%8C%D9%86%20%DA%AF%D9%88%D8%B4%D8%AA%D8%8C%20%D8%A7%D9%86%D8%AF%DB%8C%D8%B4%D9%87%D8%8C%20%D9%81%D8%A7%D8%B2%20%DB%B3&output=embed"
              className="min-h-[310px] w-full flex-1 rounded-[1.1rem] border-0"
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              allowFullScreen
            />
            <a href="#" className="animated-action flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[#d9342d] px-6 py-3 text-sm font-extrabold text-white transition hover:-translate-y-0.5 hover:bg-[#ed453e] hover:shadow-lg">
